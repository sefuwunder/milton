...
const DESCRIPTIONS: Record<string, string> = {
  ...
  reschedule_tasks: "Reschedule a task or a group of tasks (lists every move, asks first)",
  ...
  build_widget: "Draft a dashboard widget with me (filed as a proposal to preview & approve)",
  contact_detail: "Contact detail card",
  search: "Search across deals, contacts, companies, tasks",
  add_note: "Pin a note to a deal",
  log_outcome: "Log an outcome on a deal",
  create_outcome: "Create an outcome definition",
  list_outcomes: "List outcome definitions",
  show_outcome: "Show an outcome definition",
  delete_outcome: "Delete an outcome definition (asks first)",
  activate_outcome: "Activate an outcome on a deal",
...
const USAGE: Record<string, string> = {
  ...
  reschedule_tasks: "push all overdue tasks to next monday",
  ...
  build_widget: "build a widget that shows stalled deals",
  contact_detail: "who is Jane Doe",
  search: "search acme",
  add_note: "note on Acme: called today",
  log_outcome: "log outcome for Acme",
  create_outcome: "create outcome",
  list_outcomes: "outcomes",
  show_outcome: "show outcome Voicemail",
  delete_outcome: "delete outcome Voicemail",
  activate_outcome: "activate outcome Voicemail for Acme",
